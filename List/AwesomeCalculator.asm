...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	.DEF _currenct_selected_button=R5
	.DEF _currenct_operator=R4
	.DEF _index=R6
	.DEF _row=R8
	.DEF _col=R10
	.DEF _colRow=R12
...
_0x3:
	.DB  0x28,0x0,0x14,0x0,0x24,0x0,0x44,0x0
	.DB  0x12,0x0,0x22,0x0,0x42,0x0,0x11,0x0
	.DB  0x21,0x0,0x41,0x0,0x81,0x0,0x82,0x0
	.DB  0x84,0x0,0x18,0x0,0x48,0x0,0x88
_0x4:
	.DB  0x30,0x31,0x32,0x33,0x34,0x35,0x36,0x37
	.DB  0x38,0x39,0x2F,0x2A,0x2D,0x63,0x3D,0x2B
_0x1A:
	.DB  0x63,0x0,0x0,0x0
_0x0:
	.DB  0x25,0x64,0x0
...
; 0000 003E         is_selecting = 0;
	LDI  R30,LOW(0)
	STS  _is_selecting,R30
	STS  _is_selecting+1,R30
; 0000 003F     }
; 0000 0040 }
_0x5:
	RET
...
; 0000 0059             if (is_selecting == 1){
	LDS  R26,_is_selecting
	LDS  R27,_is_selecting+1
	SBIW R26,1
	BRNE _0xA
...
_0xA:
	...
	LDI  R31,HIGH(1)
	STS  _is_selecting,R30
	STS  _is_selecting+1,R31
; 0000 005E             currenct_selected_button = decoded_keys[index];
	LDI  R26,LOW(_decoded_keys)
	LDI  R27,HIGH(_decoded_keys)
	ADD  R26,R6
	ADC  R27,R7
	LD   R5,X
; 0000 005F 
...
; 0000 0091     sprintf(printable_number, "%d", number);
	LDI  R30,LOW(_printable_number)
	LDI  R31,HIGH(_printable_number)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	ST   -Y,R31
